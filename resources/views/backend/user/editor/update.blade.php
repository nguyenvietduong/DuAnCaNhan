...
@section('adminContent')
    ...
    @endif
    <form action="{{ route('editor.update', $editor->id) }}" method="post" class="box">
        @csrf
                            ...
                            <div class="row mb15">
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="email" value="{{ old('email', $editor->email ?? '') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <label for="" class="control-label text-left">Họ Tên <span
                                                class="text-danger">(*)</span></label>
                                        <input type="text" name="name" value="{{ old('name', $editor->name ?? '') }}"
                                            class="form-control" placeholder="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb15">
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="image" value="{{ old('image', $editor->image ?? '') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="date" name="birthday"
                                            value="{{ old('birthday', isset($editor->birthday) ? date('Y-m-d', strtotime($editor->birthday)) : '') }}"
                                            class="form-control" placeholder="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="address"
                                            value="{{ old('addresss', $editor->address ?? '') }}" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="phone"
                                            value="{{ old('phone', $editor->phone ?? '') }}" class="form-control"
                                            placeholder="" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <select name="publish" class="form-control setupSelect2" id="">
                                            @foreach (config('apps.setup.publish') as $key => $val)
                                                <option {{ $key == old('publish') }} value="{{ $key }}" {{ $editor->publish == $key ? "selected" : "" }}>
                                                    {{ $val }}</option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <script>
        var province_id = '{{ isset($editor->province_id) ? $editor->province_id : old('province_id') }}'
        var district_id = '{{ isset($editor->district_id) ? $editor->district_id : old('district_id') }}'
        var ward_id = '{{ isset($editor->ward_id) ? $editor->ward_id : old('ward_id') }}'
    </script>
@endsection
