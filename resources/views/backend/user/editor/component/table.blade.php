<table class="table table-striped table-bordered">
    ...
    <tbody>
        @if (isset($editers) && is_object($editers))
            @foreach ($editers as $user)
                <tr>
                    <td>
                    ...
                    <td class="text-center">
                        <a href="{{ route('editor.edit', $user->id) }}" class="btn btn-success"><i
                                class="fa fa-edit"></i></a>
                        <a href="{{ route('editor.delete', $user->id) }}" class="btn btn-danger"><i
...
{{ $editers->links('pagination::bootstrap-4') }} 
