...
@section('adminContent')
    ...
    <form action="{{ route('admin.destroy', $admin->id) }}" method="post" class="box">
        @csrf
        @method('DELETE')
                ...
                <div class="col-lg-5">
                    <div class="panel-head">
                        ...
                        <div class="panel-description">
                            <p>Bạn đang muốn xóa thành viên có email là: {{ $admin->email }}</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <label for="" class="control-label text-left"> Tên đăng nhập <span
                                                class="text-danger">(*)</span></label>
                                        <input type="text" name="username" value="{{ old('username', $admin->name ?? '') }}"
