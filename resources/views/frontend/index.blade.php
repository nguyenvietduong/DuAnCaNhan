...
<div class="banner text-center">
    @include('frontend.component.home.category')
...
<section class="section pb-0">
    <div class="container">
        <div class="row">
            ...
            @include('frontend.component.home.hot_post')
            @include('frontend.component.home.trending_post')
            @include('frontend.component.home.popular_post')
            <div class="col-12">
...
<section class="section-sm">
    <div class="container">
        <div class="row justify-content-center">
            @include('frontend.component.home.recent_post')
